...
class Storage:
    ...
    def add_modification(self, modification: StorageModification):
        ...
        elif modification.sn < len(self.log):
            assert modification == self.log[modification.sn], \
                'Received outdated inconsistent modification ' +\
                f'{modification} != {self.log[modification.sn]}'
        else:
